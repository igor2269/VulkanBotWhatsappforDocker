...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            ...
            + 'TEL;type=CELL;type=VOICE;waid=5532984885255:+55 32 98488-5255\n' // WhatsApp ID + phone number
            + 'END:VCARD';

blocked = ['17266009022@s.whatsapp.net']
prefix = botPrefix
...
async function starts() {
        ...
        lolcatjs.fromString('[DEV_TEAM] Welcome back Owner! Hope you are doing well-')
        ...
        nzwa.on('chat-update', async (mek) => {
                try {
                        ...
                        mess = {
                                ...
                                levelnol: '*Nivel atual* 0 °-°',
                                error: {
                                        stick: '[❗] Ocorreu uma falha ao converter imagem em sticker ❌',
                                        Iv: '❌ Link Invalido ❌',
                                },
                                only: {
                                        group: '[❗] Este comando so pode ser usado em grupos! ❌',
                                        ownerG: `[❗] Este comando so pode ser usado por ADM's! ❌`,
                                        admin: `[❗] Este comando so pode ser usado por ADM's! ❌`,
                                        Badmin: `[❗] Este comando so pode ser usado se o bot for ADM! ❌`,
                                        //daftarB: `──「 NÃO REGISTRADO 」──\n OLÁ !\nVC AINDA NÃO SE REGISTROU USA O COMANDO\n\nCOMANDO : ${prefix}register nome|idade\nEXEMPLO : ${prefix}register iguh|99\n\nREGISTRO MERAMENTE ILUSTRATIVO ESSA FUNÇÃO VAI SAIR EM VERSOES POSTERIORES`,
                                        daftarB: `──「 NÃO REGISTRADO 」──\nOLÁ !\nVC NÃO PODE USAR ESSE COMANDO DUVIDAS ENTRAR EM CONTATO COM O NUMERO 32 9 8488-5255 !!!`
                                }
                        }
                        ...
                        const NomerOwner = '17266009022@s.whatsapp.net'
                        ...
                        if (messagesC.includes("://chat.whatsapp.com/")) {
                                ...
                                if (isGroupAdmins) return reply('Vc não e um administrador')
                        ...
                        switch (command) {
                                case 'ajuda':
                                        ...
                                        break
                                // case '18+menu':              desativado por razoes obvias
                                //         if (!isRegister) return reply(mess.only.daftarB)
                                //         await costum(adult(prefix, botName, ownerName), text, tescuk, cr)
                                //         break
                                // case 'downloadermenu':               Erro de api
                                //         //if (!isRegister) return reply(mess.only.daftarB)
                                ...
                                case 'groupmenu':
                                        ...
                                        break
                                // case 'imagemakermenu':          Erro de api
                                //         //if (!isRegister) return reply(mess.only.daftarB)
                                //         await costum(imagemaker(prefix, botName, ownerName), text, tescuk, cr)
                                //         break
                                // case 'informationmenu':              ERRO DE API
                                //         //if (!isRegister) return reply(mess.only.daftarB)
                                ...
                                //         break
                                // case 'logomakermenu':                Erro de api
                                //         //if (!isRegister) return reply(mess.only.daftarB)
                                ...
                                case 'rebaixar':
                                        ...
                                        if (mentioned.length > 1) {
                                                ...
                                                mentions(`Reibaxado com sucesso @${mentioned[0].split('@')[0]} E um membro comum!`)
                                                nzwa.groupDemoteAdmin(from, mentioned)
                                        }
                                        break
                                ...
                                case 'promover':
                                        ...
                                        mentioned = mek.message.extendedTextMessage.contextInfo.mentionedJid
                                        if (mentioned.length > 1) {
                                                teks = 'Pedido recebido, membro adicionado como ADM :\n'
                                                for (let _ of mentioned) {
                                                        teks += `@${_.split('@')[0]}\n`
                                                }
                                                mentions(teks, mentioned, true)
                                                ...
                                                mentions(`Pedido recebido, membro adicionado como ADM  : @${mentioned[0].split('@')[0]}`, mentioned, true)
                                                nzwa.groupMakeAdmin(from, mentioned)
                                        }
                                        break
                                case 'wa.me':
                                ...
                                case 'org':
                                case 'desenvolvedor':
                                        nzwa.sendMessage(from, { displayname: "Igor", vcard: vcard }, MessageType.contact, { quoted: mek })
                                        nzwa.sendMessage(from, 'Nascimento.corp', MessageType.text, { quoted: mek })
                                        break
                                case 'hidetag':
                                        nzwa.updatePresence(from, Presence.composing)
                                        if (!isRegister) return reply(mess.only.daftarB)
